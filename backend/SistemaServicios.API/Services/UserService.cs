...
namespace SistemaServicios.API.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<(IEnumerable<UserDto> Users, int TotalCount)> GetAllUsersAsync(int page, int size)
        {
        ...
        public async Task<UserDto> CreateUserAsync(CreateUserDto dto)
        {
            ...
            var user = new User
            {
                ...
                Role = dto.Role,
                PasswordHash = BCrypt.Net.BCrypt.HashPassword(dto.Password), // Encriptación básica
